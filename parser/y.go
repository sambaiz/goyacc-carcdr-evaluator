...
var exprAct = [...]int{
	...
	1, 8, 9, 10, 2, 18, 16, 11, 7, 6,
	4, 14, 15, 12, 13, 17, 7, 3, 4, 5,
}
var exprPact = [...]int{

	1, -1000, -1000, -1000, -3, -1000, -1000, -1000, 9, 9,
	1, -1000, 2, -4, 1, -1000, -1000, -5, -1000,
}
var exprPgo = [...]int{
...
var exprChk = [...]int{
	...
	-1000, -1, -2, -4, 9, -3, 8, 7, 4, 5,
	6, 10, -2, -2, -1, 10, 10, -1, 10,
}
var exprDef = [...]int{
...
//line ../expr.y:33
		{
			exprVAL.value = exprDollar[3].value.Left
		}
	case 4:
		exprDollar = exprS[exprpt-4 : exprpt+1]
//line ../expr.y:37
		{
			exprVAL.value = exprDollar[3].value.Right
		}
	case 5:
		exprDollar = exprS[exprpt-5 : exprpt+1]
//line ../expr.y:41
		{
			exprVAL.value = &Value{Left: exprDollar[3].value, Right: exprDollar[4].value}
		}
	case 7:
		exprDollar = exprS[exprpt-1 : exprpt+1]
//line ../expr.y:48
		{
			exprVAL.value = &Value{IsNil: true}
		}
	case 8:
...
//line ../expr.y:58
		{
			exprVAL.value = &Value{Num: exprDollar[1].num}
		}
	}
